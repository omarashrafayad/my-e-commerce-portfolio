...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center max-md:mt-20">
            <div className="container flex gap-8 items-center rounded-lg overflow-hidden max-md:flex-col">
                <div className="">
                <MotionWrapper>
                    <Image
                ...
                <MotionWrapper>
                    <h2 className="text-3xl font-semibold text-gray-800 mb-2 tracking-wider max-md:text-2xl">
                        {t('title')}
                    </h2>
                    ...
                    <p className="text-sm text-gray-600 mt-4 text-center ">
                        ...
                        <Link href={`/${locale}/login`} aria-label={t('login')} className="text-[var(--color-secondary)] hover:underline">
                            {t('login')}
                        </Link>
                    </p>
                </MotionWrapper>
